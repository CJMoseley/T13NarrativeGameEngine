...
// This does not wobble and vibrate as required and we probably need to start again with it.
// The wormole is meant to open with a funnel shape at the start, then stabilize into a tube, and then close with a funnel shape at the end.
...
export class WormholeEnvironment {
    /**
