...
### 1. ViewManager (`js/core/ViewManager.js`)
...
### 2. Scene Manager (`js/core/SceneManager.js`)
...
### 4. LoaderManager (`js/core/LoaderManager.js`)
...
### 5. ShipFactory (`js/core/ship/ShipFactory.js`)
