...
window.T13NE.CardsNPC =function(props){
			...
			return (
				window.T13NE.CE("div", {className: props.className+"-div t13ne-card-yarn-npc",  "tabIndex":0,"key":window.T13NE.KeyGen(tcard["Archetype"])}, [
					...
					window.T13NE.FacetAspectBox({className:props.className+"-facet-box t13ne-archetype-persona", "data-aspect":"Persona", "data-facet":tcard["Persona"]}),
					window.T13NE.FacetAspectBox({className:props.className+"-titled t13ne-archetype-core", "data-aspect":"Core", "data-facet":tcard["Core"]}),
					window.T13NE.FacetAspectBox({className:props.className+"-titled t13ne-archetype-hitch","title":"Hitch", "data-aspect":"Hitch", "data-facet":tcard["Hitch"]}),
				])
				);
...
window.T13NE.CardsRevelation =function(props){
		...
		var revarr =[window.T13NE.CE(window.T13NE.TextBox, {className:props.className+"-about", title:"About", "data-type":{internal:revs.About}, "data-description":{internal:revs["About_Description"]}, "tabIndex":0,"key":window.T13NE.KeyGen(revs.About)}, null)
		...
		,window.T13NE.CE(window.T13NE.TextBox, {className:props.className+"-vector", title:"Vector", "data-type":{internal:revs.Vector}, "data-description":{internal:revs["Vector_Description"]},"key":window.T13NE.KeyGen(revs.Vector)})
		, window.T13NE.CE(window.T13NE.TextBox, {className:props.className+"-alt", title:"Alternate Information", "data-type":{internal:revs.Alternate}, "data-description":{internal:revs["Alternate_Description"]},"key":window.T13NE.KeyGen(revs.Alternate)})
		, window.T13NE.CE(window.T13NE.TextBox, {className:props.className+"-details", title:"Detail", "data-type":{internal:revs.Detail}, "data-description":{internal:revs["Detail_Description"]},"key":window.T13NE.KeyGen(revs.Detail)})];
		...
		return(window.T13NE.CE("section",{className:props.className+"-section","key":window.T13NE.KeyGen("section"+revs.Info)}, 
			...
			window.T13NE.CE("main", {className:props.className+"-main","key":window.T13NE.KeyGen("revs main"+revs.Info)}, revarr )]));
};
			...
			window.T13NE.CE( "article", {className:props.className+"-stress t13ne-tooltip", "tabIndex":0,"key":window.T13NE.KeyGen("stressarticle"+stress.Type)},[ 
      		window.T13NE.StressIcon,
				window.T13NE.CE("main", {className: props.className+"-main t13ne-tooltip t13ne-stress", "tabIndex":0,"key":window.T13NE.KeyGen("mainstress"+stress.Type)}, 
					window.T13NE.CE(window.T13NE.TextBox, {className:props.className+"-desc t13ne-stress", "title":{internal:"Stress: "+stress.Type}, "data-description":{internal:stress.Description}, "data-rules": {internal:stress.Rules},"key":window.T13NE.KeyGen(stress.Type)}, null),	
					)		
				]
				)		
			);
	...
	return(
		window.T13NE.CE("article", {className: props.className+"-div t13ne-tooltip t13ne-card-ordeals","key":window.T13NE.KeyGen(obstacle['Type']+"art")},  [
			window.T13NE.CE("main", {className:props.className+"-main t13ne-tooltip"},	[				
				...
				window.T13NE.FacetDisplay({className: props.className+"-test t13ne-test", "title":"Suggested Test", "data-facet":facet, "data-mode":"ordeal","key":window.T13NE.KeyGen(obstacle['Type']+"test")}),
...
// window.T13NE.writeCardDetails = function (stuff){
// 	//console.log("trying to write =",stuff);
// 	var t13card=stuff["data-t13necard"];
// 	var cssName = stuff['cssName'];
// 	var tcard=window.T13NE.Cards[t13card];
// 	var ordeal=stuff['data-t13neordeal'];
// 	var wyrd=stuff['data-t13newyrd'];
// 	var yarn=stuff['data-t13neyarn'];
// 	var lea=stuff['data-t13nelea'];
// 	var stress=stuff['data-t13nestress'];
// 	var unicode=stuff['data-t13neunicode'];
// 	var cardname = tcard.Card+" of "+ window.T13NE.Suits[tcard.Suit]["Suit"];
	
// 	var ret = window.T13NE.CE("div", {className:cssName+"-div t13ne-card-corner","key":window.T13NE.KeyGen(tcard.Unicode+"corner")}, window.T13NE.CE("span", { className: cssName + "-span", "title": cardname, "key": window.T13NE.KeyGen(tcard.Unicode + "cardname") }, window.T13NE.CE(window.T13NE.Suits.DisplayBox, {className: cssName+"-suit t13ne-card-suit", "data-suit":tcard.Suit, "data-mode":"cardcorner","key":window.T13NE.KeyGen(tcard.Unicode+"cardcorner")}, tcard["Card_Corner"])),	window.T13NE.CE(window.T13NE.TextBox, { className: cssName + "-div t13ne-card-pips", "title": "Pips (<abbr title=\"Penetration Bonus\">Pen</abbr>): ", "data-description": tcard.Pips + " (+" + window.T13NE.Boon.getBoonReduced(parseInt(tcard.Pips)) + ")", "key": window.T13NE.KeyGen(tcard.Unicode + "pips") }, null),
// 			window.T13NE.CE(window.T13NE.TextBox, { className: cssName + "-div narrative-meaning", "title": "Narrative Meaning", "data-description":tcard.Narrative_Meaning}),
// 			window.T13NE.CE(window.T13NE.FacetDisplay, {className: cssName+"-facets t13ne-facets", "data-facets":tcard.Facet, "data-mode":"card","key":window.T13NE.KeyGen(tcard.Unicode+"facets")}, null),
// 			(unicode)?window.T13NE.CE("span", {className:cssName+"-unicode t13ne-unicode-card", dangerouslySetInnerHTML:{__html:tcard.Unicode},"key":window.T13NE.KeyGen(tcard.Unicode)},null):null,					
// 			window.T13NE.CE(window.T13NE.Wound, {className: cssName+"-wound", "data-t13newound-level":tcard["Wound_Level"],"key":window.T13NE.KeyGen(tcard.Unicode+"wound")},null),
// 			(yarn)?(window.T13NE.CE(window.T13NE.CardsYarn, {className:cssName+"-yarn t13ne-card-details-yarn","data-t13necard":t13card,"key":window.T13NE.KeyGen(tcard.Unicode+"yarn")})):null,
// 			(wyrd)?(window.T13NE.CE(window.T13NE.CardsWyrd, {className:cssName+"-wyrd t13ne-card-details-wyrd","data-t13necard":t13card,"key":window.T13NE.KeyGen(tcard.Unicode+"wyrd")})):null,
// 			(lea)?(window.T13NE.CE(window.T13NE.CardsLea, {className:cssName+"-lea t13ne-card-details-lea","data-t13necard":t13card,"key":window.T13NE.KeyGen(tcard.Unicode+"lea")})):null,
// 			(ordeal)?(window.T13NE.CE(window.T13NE.CardsOrdeal, {className:cssName+"-ordeal t13ne-card-details-ordeal","data-t13necard":t13card,"key":window.T13NE.KeyGen(tcard.Unicode+"ordeal")})):null,
// 			(stress)?(window.T13NE.CE(window.T13NE.CardsStress, {className:cssName+"-stress t13ne-card-details-stress","data-t13necard":t13card,"key":window.T13NE.KeyGen(tcard.Unicode+"stress")})):null,
// 			(stress)?(window.T13NE.CE(window.T13NE.CardsTrauma, {className:cssName+"-trauma t13ne-card-details-trauma","data-t13necard":t13card,"key":window.T13NE.KeyGen(tcard.Unicode+"trauma")})):null
// 		);
// 	//console.log("writing",ret);
// 	return ret;
// }
/* window.T13NE.CardsDetails = class extends window.T13NE.Component{
      ...
      Image: "",
		render (){
			...
			var cardContents = {
				...
				"facets":window.T13NE.CE(window.T13NE.FacetDisplay, {className: this.state.className+"-facets t13ne-facets", "data-facets":tcard.Facet, "data-mode":"card","key":window.T13NE.KeyGen(tcard.Unicode+"facets")}, null),
			...
			return (
				window.T13NE.CE("figcaption", {className:this.state.className+"-figcaption t13ne-card-details","key":window.T13NE.KeyGen(tcard.Unicode+"caption")},
					...
					window.T13NE.CE(window.T13NE.TextBox, { className: this.state.className + "-div narrative-meaning", "title": "Narrative Meaning", "data-description":tcard.Narrative_Meaning}),
					cardContents["facets"],
  ...
  //single cards
window.T13NE.T13CardIcon= window.T13NE.CE("svg", {"xmlns":"http://www.w3.org/2000/svg", viewBox:"0 0 512 512",'key':window.T13NE.KeyGen('cardicon-svg') },window.T13NE.CE("polygon", {points:"256,512,0,256,256,0,512,256", fill:"#32373c" ,"fillOpacity":"0",'key':window.T13NE.KeyGen('cardicon-polygon')},null),
    window.T13NE.CE("g",{'key':window.T13NE.KeyGen('cardicon')},
      ...
      window.T13NE.CE("g", {transform:"translate(273,208)",'key':window.T13NE.KeyGen('cardicon-g')}, 
          window.T13NE.CE("g", {transform:"translate(6.4, 6.4) scale(0.8, 0.8) rotate(0, 128, 128)", 'key':window.T13NE.KeyGen('cardicon-gg')},
            window.T13NE.CE("circle" ,{cx:"128", cy:"128", r:"128", fill:"#32373c" ,"fillOpacity":"1", 'key':window.T13NE.KeyGen('cardicon-circle')},null),
            window.T13NE.CE("circle", {stroke:"#fff", "strokeOpacity":"1", fill:"#32373c" ,"fillOpacity":"1", "strokeWidth":"18", cx:"128", cy:"128", r:"101", 'key':window.T13NE.KeyGen('cardicon-2circle')},null),
            window.T13NE.CE("path", {fill:"#fff", "fillOpacity":"1", "d":"M119 64v55H64v18h55v55h18v-55h55v-18h-55V64h-18z", 'key':window.T13NE.KeyGen('cardicon-path')},null)))
      ,window.T13NE.CE("g", {"fontFamily":"&quot;Times New Roman&quot;, Times, serif", "fontSize":"85", "fontStyle":"italic", "fontWeight":"bold", "textAnchor":"middle", transform:"translate(168,398)", 'key':window.T13NE.KeyGen('cardicon-ggg')},
        window.T13NE.CE("text", {stroke:"rgba(255, 255, 255, 0)", "strokeWidth":"21.25",'key':window.T13NE.KeyGen('cardicon-text')},
          window.T13NE.CE("tspan",{x:"0", y:"0",'key':window.T13NE.KeyGen('cardicon-tspan')},"T13")),
        window.T13NE.CE("text",{fill:"#32373c",'key':window.T13NE.KeyGen('cardicon-text2')},
          window.T13NE.CE("tspan",{x:"0", y:"0",'key':window.T13NE.KeyGen('cardicon-tspan2')},"T13")))));


window.T13NE.CardFace = function (props, state, csser, temp13, carteRef){
	
	var text=(window.T13NE.CE("figure",
		{
			"className" : csser,
		   "id" : props.id,
		   "data-mode" : (props["data-mode"]!==undefined)?props["data-mode"]:"jsvg",
		   "t13card":props.t13card,
		   "data-t13nelea": props["data-t13nelea"],
		   "data-t13necard" : state.currentCard,
		   "data-t13newyrd" : props["data-t13newyrd"],
		   "data-t13neyarn" : props["data-t13neyarn"],
		   "data-t13neordeal" :props["data-t13neordeal"],
			"data-t13nestress": props["data-t13nestress"],
		   "data-t13nefaceup" : "faceup",
		   "data-t13neunicode":props["data-t13neunicode"],
		   "draggable" : true,
		   ...
		   "tabIndex":0,
		   "key":window.T13NE.KeyGen("faceup"+props.t13card) +"-"+ Math.random().toString(36).substr(2, 7)+"-"+ Math.random().toString(36).substr(2, 7),
		   "ref":carteRef,
		 
	   },
	    [window.T13NE.CE("img", {"src":window.T13NE.t13url + temp13['Svg'], className:"t13ne-svgcard"}, null), 
		window.T13NE.CE("figcaption", {className:csser+"-figcaption t13ne-card-details","key":window.T13NE.KeyGen(props.t13card+"caption")},[
		 window.T13NE.CE("div", {className:csser+"-div t13ne-card-corner","key":window.T13NE.KeyGen(window.T13NE.Cards[props.t13card].Unicode+"corner")},
		 [window.T13NE.CE("span", { className: csser + "-span", "title": window.T13NE.Cards[props.t13card].Card+" of "+ window.T13NE.Suits[window.T13NE.Cards[props.t13card].Suit]["Suit"], "key": window.T13NE.KeyGen(window.T13NE.Cards[props.t13card].Unicode + "cardname") },  [window.T13NE.CE("span",{className: csser+"-suit t13ne-card-name"}, window.T13NE.Cards[props.t13card]["Card_Corner"]), 
		window.T13NE.Suits.writeSuit({className: csser+"-suit t13ne-card-suit", "data-suit":window.T13NE.Cards[props.t13card].Suit, "data-mode":"cardcorner","key":window.T13NE.KeyGen(window.T13NE.Cards[props.t13card].Unicode+"cardcorner")})] 
		  ),window.T13NE.CE(window.T13NE.TextBox, { className: csser + "-div t13ne-card-pips", "title": "Pips (<abbr title=\"Penetration Bonus\">Pen</abbr>): ", "data-description": window.T13NE.Cards[props.t13card].Pips + " (+" + window.T13NE.Boon.getBoonReduced(parseInt(window.T13NE.Cards[props.t13card].Pips)) + ")", "key": window.T13NE.KeyGen(window.T13NE.Cards[props.t13card].Unicode + "pips") }, null), window.T13NE.CE(window.T13NE.TextBox, { className: csser + "-div narrative-meaning", "title": "Narrative Meaning", "data-description":window.T13NE.Cards[props.t13card].Narrative_Meaning}),window.T13NE.FacetDisplay( {className: csser+"-facets t13ne-facets", "data-facets":window.T13NE.Cards[props.t13card].Facet, "data-mode":"card","key":window.T13NE.KeyGen(window.T13NE.Cards[props.t13card].Unicode+"facets")}),
				   (props["data-t13neunicode"])?window.T13NE.CE("span", {className:csser+"-unicode t13ne-unicode-card", dangerouslySetInnerHTML:{__html:window.T13NE.Cards[props.t13card].Unicode},"key":window.T13NE.KeyGen(window.T13NE.Cards[props.t13card].Unicode)},null):null]),
				   window.T13NE.CE(window.T13NE.Wound, {className: csser+"-wound", "data-t13newound-level":window.T13NE.Cards[props.t13card]["Wound_Level"],"key":window.T13NE.KeyGen(window.T13NE.Cards[props.t13card].Unicode+"wound")},null),
				   (props["data-t13neyarn"])?(window.T13NE.CE(window.T13NE.CardsYarn, {className:csser+"-yarn t13ne-card-details-yarn","data-t13necard":props.t13card,"key":window.T13NE.KeyGen(window.T13NE.Cards[props.t13card].Unicode+"yarn")})):null,
				   (props["data-t13newyrd"])?(window.T13NE.CE(window.T13NE.CardsWyrd, {className:csser+"-wyrd t13ne-card-details-wyrd","data-t13necard":props.t13card,"key":window.T13NE.KeyGen(window.T13NE.Cards[props.t13card].Unicode+"wyrd")})):null,
				   (props["data-t13nelea"])?(window.T13NE.CE(window.T13NE.CardsLea, {className:csser+"-lea t13ne-card-details-lea","data-t13necard":props.t13card,"key":window.T13NE.KeyGen(window.T13NE.Cards[props.t13card].Unicode+"lea")})):null,
				   (props["data-t13neordeal"])?(window.T13NE.CE(window.T13NE.CardsOrdeal, {className:csser+"-ordeal t13ne-card-details-ordeal","data-t13necard":props.t13card,"key":window.T13NE.KeyGen(window.T13NE.Cards[props.t13card].Unicode+"ordeal")})):null,
				   (props["data-t13nestress"])?(window.T13NE.CE(window.T13NE.CardsStress, {className:csser+"-stress t13ne-card-details-stress","data-t13necard":props.t13card,"key":window.T13NE.KeyGen(window.T13NE.Cards[props.t13card].Unicode+"stress")})):null,
				   (props["data-t13nestress"])?(window.T13NE.CE(window.T13NE.CardsTrauma, {className:csser+"-trauma t13ne-card-details-trauma","data-t13necard":props.t13card,"key":window.T13NE.KeyGen(window.T13NE.Cards[props.t13card].Unicode+"trauma")})):null,
	   ])]));
	   //console.log("card face text=", text);
	   return text;
}
  ...
  window.T13NE.T13Card = class extends window.T13NE.Component { 
	...
	////console.log("just in case props", props);
		//bindings
		this.carteRef = window.React.createRef();
	...
	componentDidMount(){
		...
		if (!this.props["data-hydrate"]){
			var carte =this.carteRef.current.outerHTML;
			//console.log("mounted=",JSON.stringify(carte));
    ...
    render(here){
    	...
    	/* this.details=window.T13NE.writeCardDetails({
	     			"cssName":this.csser,
			        ...
			        ,"key":window.T13NE.KeyGen("cardwrap"+this.state.currentCard) +"-"+ Math.random().toString(36).substr(2, 7)+"-"+ Math.random().toString(36).substr(2, 7)}) ; */
    	////console.log("details=",this.details);
    	////console.log("csser ", this.csser);
	   	this.face=null;
	   	switch(this.state.faceup){
    			case "faceup":this.face=window.T13NE.CardFace(this.props, this.state, this.csser, this.temp13card, this.carteRef)
    			break;
    	...
    	if (here===undefined){
    		...
    		if (here=="toString"){
    			...
    			if (thisun){
					var root=createRoot(thisun);
    				root.Render(this.face,thisun);
    				return null;
    			}
