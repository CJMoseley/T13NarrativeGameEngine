...
class T13_Element_Admin {
	...
	public function init() {
		...
		/*foreach ($this->registration_handler->$post_type as $pk=>$pval){
			add_filter( 'manage_edit-'.$pval.'_columns', array( $this, 'add_image_column'), 10, 1 );
			add_action( 'manage_'.$pval.'_posts_custom_column', array( $this, 'display_image' ), 10, 1 );
		}
		*/
	...
	public function add_image_column( $columns ) {
		$column_thumbnail = array( 'thumbnail' => __( 'Image', 't13ne' ) );
