...
if(!window.T13NE.CE){
  ...
  window.T13NE.CE = window.React.createElement?window.React.createElement:window.wp.element.createElement;
 }
  ...
  window.T13NE.Render = window.ReactDOM.render?window.ReactDOM.render:window.wp.element.render;
  ...
  window.T13NE.This = function (me,mine){
    ...
    if (window.wp.element.findDomNode){
      node =window.wp.element.findDomNode(me);
    }
    if (window.ReactDOM.findDomNode){
     node =window.ReactDOM.findDomNode(me);
    }
    return [node,mine,me];
  }
window.T13NE.Paths={
...
window.T13NE.Contains = function (haystack,needles, defaultret=false){
  ...
  if (needles===[]||needles==""||needles===null||needles===undefined||haystack===undefined||haystack===[]||haystack===""||haystack===null){return defaultret;}
